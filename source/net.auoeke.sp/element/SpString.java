...
public final class SpString implements SpPrimitive {
    ...
    public SpString(CharSequence value, CharSequence delimiter) {
        this.value = Objects.requireNonNull(value).toString();
        this.delimiter = delimiter;
    }

    public SpString(CharSequence value) {
        this(value, null);
    ...
    @Override public boolean equals(Object other) {
        return other instanceof SpString string && this.value.equals(string.value) && Objects.equals(this.delimiter(), string.delimiter());
    }
