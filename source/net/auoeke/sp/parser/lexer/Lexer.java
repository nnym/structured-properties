package net.auoeke.sp.parser.lexer;
...
import net.auoeke.sp.parser.lexer.lexeme.CommaLexeme;
import net.auoeke.sp.parser.lexer.lexeme.CommentLexeme;
import net.auoeke.sp.parser.lexer.lexeme.DelimiterLexeme;
import net.auoeke.sp.parser.lexer.lexeme.Lexeme;
import net.auoeke.sp.parser.lexer.lexeme.MappingLexeme;
import net.auoeke.sp.parser.lexer.lexeme.NewlineLexeme;
import net.auoeke.sp.parser.lexer.lexeme.StringLexeme;
import net.auoeke.sp.parser.lexer.lexeme.Token;
import net.auoeke.sp.parser.lexer.lexeme.WhitespaceLexeme;
...
public class Lexer {
    ...
    public Lexer(String source, boolean retainSource, boolean throwExceptions, StructuredProperties.Option... options) {
        this.source = source;
