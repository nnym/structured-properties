...
public class Lexer {
    ...
    public Lexer(String source, boolean retainSource, boolean throwExceptions, Lusr.Option... options) {
        this.source = source;

        var optionSet = new HashSet<>(Arrays.asList(options));
        this.retainComments = optionSet.contains(Lusr.Option.RETAIN_COMMENTS);
    ...
    public Lexer(String source, Lusr.Option... options) {
