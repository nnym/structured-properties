...
public final class LusrString implements LusrPrimitive {
    ...
    public LusrString(CharSequence value, CharSequence delimiter) {
        this.value = Objects.requireNonNull(value).toString();
        this.delimiter = delimiter;
    }

    public LusrString(CharSequence value) {
        this(value, null);
    ...
    @Override public boolean equals(Object other) {
        return other instanceof LusrString string && this.value.equals(string.value) && Objects.equals(this.delimiter(), string.delimiter());
    }
